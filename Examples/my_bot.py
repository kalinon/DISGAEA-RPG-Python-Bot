...
# bot.clear_event(get_event_areas(1213), team_num=26, raid_team=23)

# 1201105311 - Extra+ (HL)
# 1201105312 - Extra+ (EXP)
# 1201105313 - Extra+ (1★)
# 1201201103 - Hidden Stage -HARD-

# bot.do_quest(1201201103, team_num=2, auto_rebirth=True)
# bot.clear_inbox()
# exit(0)
# Daily tasks
...
# Full loop
bot.loop(
    team=26, rebirth=True, farm_stage_id=1213105312,
